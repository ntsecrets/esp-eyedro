...
#define EEPROM_EYEDRO1_LENGTH 16
...
#define EEPROM_EYEDRO1_OFFSET EEPROM_SPACEMODE_OFFSET + EEPROM_SPACEMODE_OFFSET_LENGTH
#define EEPROM_EYEDRO1_OFFSET_LENGTH 16

#define EEPROM_REFRESH_OFFSET EEPROM_EYEDRO1_OFFSET + EEPROM_EYEDRO1_OFFSET_LENGTH
#define EEPROM_REFRESH_OFFSET_LENGTH 4
...
#define DEFAULT_EYEDRO1 "192.168.81.157"
...
class Settings {
  ...
  public:
    ...
    void Load() {
      ...
      strncpy(eyedro1, &buffer[EEPROM_EYEDRO1_OFFSET], EEPROM_EYEDRO1_LENGTH);
      if (strlen(eyedro1) < 1) {
        strcpy(eyedro1, DEFAULT_EYEDRO1);
      }
   ...
   //   strncpy(timeserver1, &buffer[EEPROM_TIMESERVER1_OFFSET], EEPROM_TIMESERVER1_LENGTH);
      ...
      refresh1 = int(buffer[EEPROM_REFRESH_OFFSET]);
    ...
    //  strncpy((char *)&buffer[EEPROM_TIMESERVER1_OFFSET], (char *)timeserver1, EEPROM_TIMESERVER1_LENGTH);
     ...
     strncpy((char *)&buffer[EEPROM_EYEDRO1_OFFSET], (char *)eyedro1, EEPROM_EYEDRO1_LENGTH);
      buffer[EEPROM_REFRESH_OFFSET] = refresh1;
  ...
  //    buffer[EEPROM_EYEDRO1_OFFSET] = DEFAULT_EYEDRO1;
      buffer[EEPROM_REFRESH_OFFSET] = DEFAULT_REFRESH;

       strncpy((char *)&buffer[EEPROM_EYEDRO1_OFFSET], DEFAULT_EYEDRO1, EEPROM_EYEDRO1_LENGTH);
