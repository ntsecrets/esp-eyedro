...
<div class=title>KWH Monitor @@VERSION@@</div>
...
<tr><td>eyedro1:</td><td><input type=text name="eyedro1" value="@@EYEDRO1@@" size=16></td><tr>
<tr><td>refresh interval:</td><td><input type=text name="refresh1" value="@@REFRESH1@@" size=3></td><tr>
</table>
<p>
